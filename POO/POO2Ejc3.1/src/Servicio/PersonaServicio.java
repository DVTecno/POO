 ...
 * deberá mostrar un mensaje Método calcularIMC(): calculara si la persona está
 * en su peso ideal (peso en kg/(altura^2 en mt2)). Si esta fórmula da por
...
public class PersonaServicio {
    ...
    public Persona crearPersona() {
        ...
        leer.nextLine(); // Consumir la nueva línea en el búfer del scanner
        return persona;
